    ...
    <div className="flex flex-col gap-6">
      ...
      <form onSubmit={podnesiFormu} className="grid gap-4">
        ...
        <div className="flex items-center gap-3">
          <button
            type="submit"
            className="flex items-center justify-center gap-2 px-5 py-2 rounded-xl bg-gradient-to-r from-green-500 to-green-600 text-white font-semibold shadow-md hover:brightness-110 active:scale-95 transition disabled:opacity-60"
            disabled={loading}
          >
